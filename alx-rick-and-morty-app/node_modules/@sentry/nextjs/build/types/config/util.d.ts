 ...
 */
export declare function isTurbopackDefaultForVersion(version: string): boolean;
/**
 ...
 */
export declare function detectActiveBundler(nextJsVersion: string | undefined): 'turbopack' | 'webpack' | undefined;
